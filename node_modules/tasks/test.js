...
linearQueue.on('completed', function() { console.log("Linear queue empty."); });
concurrentQueue.on('completed', function() { console.log("Concurrent queue empty."); });
workGroup.on('completed', function() { console.log("Work group complete.");});